...
- Keep clearnotes.md readable: use headings, 2–4 sentence paragraphs, and 1–3 bullet lists where helpful.
- Length limits: clearnotes.md ~400–800 words; summary.md max 120 words.
- Produce a short TODO list at the end of clearnotes.md with 3 actionable next steps (owner role, estimate hours).
...
Acceptance criteria:
- roughnotes.md contains the raw points returned by the tool (verbatim bullets).
- clearnotes.md reorganizes those points into the specified sections and includes a practical example and exercise.
- summary.md contains a concise TL;DR plus 3 bullets.
